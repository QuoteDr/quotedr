...
assert(quote.includes('terms_accepted_snapshot'), 'quote viewer should preserve the terms acknowledgement evidence');
...
assert(recordBlock.includes('patch.terms_accepted !== true'), 'server should require terms acknowledgement');
assert(recordBlock.includes('merged.signed_at = now'), 'server should author the signed timestamp');
assert(recordBlock.includes('merged.terms_accepted_at = now'), 'server should author the terms acknowledgement timestamp');
...
assert(clientUpdateBlock.includes('merged.signed_at = now'), 'server should author the quote signed timestamp');
assert(clientUpdateBlock.includes('merged.terms_accepted_at = now'), 'server should author the quote terms timestamp');
