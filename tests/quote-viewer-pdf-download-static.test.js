...
assert(source.includes('Download / Print PDF'), 'PDF button should be labelled as the single download/print action');
assert(!source.includes('Print / Save as PDF'), 'quote viewer should not show a second direct print/save PDF button');
