...
const migration = read('supabase/migrations/20260720012053_stripe_connect_document_payments.sql');
const partialDepositMigration = read('supabase/migrations/20260819011012_partial_deposit_summary_state.sql');
