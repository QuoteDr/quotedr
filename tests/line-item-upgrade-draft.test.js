...
assert(builder.includes('quote-items.js?v=2026091405'), 'new HTML must request the matching item-editor script');
assert(builder.includes('quote-storage.js?v=2026091405'), 'quote storage must use the matching release');
